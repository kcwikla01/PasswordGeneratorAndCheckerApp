document.addEventListener("DOMContentLoaded", function() {
    ...
    function updatePasswordStrength(password) {
        ...
        if (isSequential && entropy>=40) {
            ...
            passwordLengthMessage.textContent = 'Słabe hasło (hasło zawiera powtarzające się znaki co najmniej 4 razy oraz ma mało znaków oraz ich słabe zróżnicowanie)';
